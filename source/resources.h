...
#define STATUS_SERVER_NAME "The Forgotten Server - Edited By Cyko V8"
#define STATUS_SERVER_VERSION "0.3.6 - Edited By Cyko V8"
#define STATUS_SERVER_CODENAME "Crying Damson - Edited By Cyko V8"
